...
<body>
  ...
  <strong> <p class="text-justify
            ...
            <p class="text-justify text-break"><strong>II.</strong> Que en fecha <u>{{ Str::upper(\Jenssegers\Date\Date::parse($fecha_inicio)->format('l d F')) }} DEL {{ $año }}</u> el <strong>CLIENTE</strong> solicitó la 
                <strong>AMPLIACIÓN DE LA VIGENCIA y EL DECREMENTO DE LA CANTIDAD </strong> entregada en mutuo a través de la plataforma <u>https://finverr.com.</u>
            </p>
            ...
            <p class="text-justify text-break">Con lo anterior se tiene por cierto y manifestado que ha aceptado los términos y condiciones de 
                    ...
                    <p class="text-justify text-break">Este Contrato se suscribirá por <strong>LAS PARTES</strong> a través de medios electrónicos, 
                        ...
                        información generada para cualquier consulta posterior, en términos de lo establecido en el Código de Comercio.
                         ...
                         medio del código en cadena que se genere por el simple hecho de hacer clic en los botones de aceptación que se 
                         presenten dentro de la página web mencionada, considerando que el <strong>PRESTADOR</strong> tiene la capacidad de establecer un 
                ...
                <p class="text-justify text-break"><strong>3.- <U>DECREMENTO.</U> LAS PARTES</strong> convienen el DECREMENTO de la cantidad de dinero entregada 
                en mutuo para quedar en <u>{{ $inversion->cantidad }}  
                ({{ $cantidadLetras }}).,</u> por lo que en este acto <strong>EL PRESTADOR</strong> devolverá a <strong>EL CLIENTE</strong> mediante 
                transferencia electrónica dentro de los 30 días de la misma manera que le fue entregada al <strong>PRESTADOR</strong> posteriores 
                a la firma del presente Convenio, la cantidad de <u>${{ $diferenciaFormateada }}
                ({{ $cantidadLetrasdiferencia }}).,</u> para la actualización del DECREMENTO mediante transferencia electrónica a la cuenta señalada 
                por <strong>EL CLIENTE</strong> en la Caratula de <strong>EL CONTRATO.</strong>
                </p>
            ...
            <strong>4.- <u>INTERESES ORDINARIOS.</u> LAS PARTES</strong> acuerdan que la actualización de la cantidad
             de dinero entregada en mutuo <u>{{ $mensajeIntereses }}</U> estipulados en la Cláusula 3.- de <strong>EL CONTRATO.</strong>
            </p>
