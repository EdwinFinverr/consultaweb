...
<style>
 ...
 <br>
    ...
    <p class="text-justify
        ...
        <p class="text-justify text-break">b. {{ $inversion->empresa_inversion_id == 1 ? 'Que su representante legal la C. 
        ...
        <p class="text-justify text-break">c. {{ $inversion->empresa_inversion_id == 1 ? 'Tener por objeto social entre 
            ...
            arrendamiento, compra, venta de bienes inmuebles y de materiales y maquinaria, así como la explotación de
             franquicias relativas al sector inmobiliario. ' : 'Tener por objeto social entre otras actividades las 
             siguientes ramas: Ingeniería en construcción, desarrollo inmobiliario, urbanización, arrendamiento, compra, 
             venta de bienes inmuebles y de materiales y maquinaria, así́ como la explotación de franquicias relativas al sector inmobiliario. ' }} . </p>
        <p class="text-justify text-break">d. {{ $inversion->empresa_inversion_id == 1 ? 'Tener su domicilio ubicado 
            en Avenida Independencia número 1830 interior 106-A, colonia Jardines de la Concepción II, C.P. 20120, 
            de la ciudad de Aguascalientes, Ags. el cuál en este acto señala para oír y recibir todo tipo de notificaciones 
            y documentos.' : 'Tener su domicilio ubicado en Avenida Independencia número 2351 interior 111-B, centro comercial 
        ...
        <p class="text-justify text-break">e. {{ $inversion->empresa_inversion_id == 1 ? 'Estar inscrito en el Registro
             Federal de Contribuyentes, con clave CCD190208GL9 como lo acredita la copia simple de su cédula de 
             identificación fiscal, previo cotejo de su original.' : 'Estar inscrito en el Registro Federal de Contribuyentes, 
             con clave FCG170214GL3 como lo acredita la copia simple de su cédula de identificación fiscal, previo cotejo de su original.' }} .
        </p>
        ...
        <p class="text-justify text-break">Este Contrato se suscribirá por las partes, ya sea de manera física
            ...
            por la cantidad
            de {{ $inversion->cantidad }} MXN  ({{ $montoLetras  }}) para invertir en los proyectos que se encuentran desarrollándose del
            PRESTADOR
        ...
        @foreach ($proyecto as $proyectos)
        <p class="text-justify text-break">Contrato firmado electrónicamente atraves del representante legal  {{ $proyectos->proyecto }} y {{ $user->name . ' ' . $user->lastName }}
        </p>
        @endforeach
