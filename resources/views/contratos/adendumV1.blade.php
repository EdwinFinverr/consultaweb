...
<body>
    ...
    <h2 class="text-center"
        ...
        <strong> <p class="text-justify
            ...
            celebraron el Contrato de Mutuo con Intereses identificado con el número de folio {{ $inversionBase->folio }}, en lo sucesivo <strong>EL CONTRATO</strong>. Del cual, han convenido 
